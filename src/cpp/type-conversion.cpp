...
namespace TypeConversion {
  // Build a boxed GstVideoTimeCode from either a structured JS object
  // { hours, minutes, seconds, frames, dropFrame?, fpsN?, fpsD? } or an
  // "HH:MM:SS:FF" / "HH:MM:SS;FF" string, and store it in out_value. Only the
  // H:M:S:F value and drop-frame flag are meaningful for set-internal-timecode
  // — the stamper derives fps/flags from negotiated caps.
